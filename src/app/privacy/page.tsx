      ...
      <div className="max-w-4xl mx-auto p-6 md:p-8">
        ...
        <div className="space-y-6 text-gray-300">
          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <p className="mb-4">ASCENDANTACADEMY.CA understands that your privacy is important to you. We are committed to protecting the privacy of your personally-identifiable information as you use this website. This Privacy Policy tells you how we protect and use information that we gather from you. By using this website, you consent to the terms described in the most recent version of this Privacy Policy. You should also read our Terms of Use to understand the general rules about your use of this website, and any additional terms that may apply when you access particular services or materials on certain areas of this website. "We," "our" means ascendantacademy.ca and its affiliates. "You," "your," visitor," or "user" means the individual accessing this site.</p>
          </section>

          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">Personal and non-personal information</h2>
            <p>Our Privacy Policy identifies how we treat your personal and non-personal information.</p>
          </section>

          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">What is non-personal information and how is it collected and used?</h2>
            <p>Non personal information is information that cannot identify you. If you visit this web site to read information, such as information about one of our services, we may collect certain non-personal information about you from your computer's web browser. Because non-personal information cannot identify you or be tied to you in any way, there are no restrictions on the ways that we can use or share non-personal information. What is personal information and how is it collected? Personal information is information that identifies you as an individual, such as your name, mailing address, e-mail address, telephone number, and fax number. We may collect personal information from you in a variety of ways:</p>
          ...
          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">Does ascendantacademy.ca share personal information with others?</h2>
          ...
          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">How is personal information used for communications?</h2>
          ...
          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">How is personal information secured?</h2>
          ...
          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            ...
            <p>This site contains links to other sites that provide information that we consider to be interesting. ascendantacademy.ca is not responsible for the privacy practices or the content of such web sites.</p>
          </section>

          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">Public discussions</h2>
            <p>This site may provide public discussions on various business valuation topics. Please note that any information you post in these discussions will become public, so please do not post sensitive information in the public discussions. Whenever you publicly disclose information online, that information could be collected and used by others. We are not responsible for any action or policies of any third parties who collect information that users disclose in any such forums on the web site. ascendantacademy.ca does not agree or disagree with anything posted on the discussion board. Also remember that you must comply with our other published policies regarding postings on our public forums.</p>
          </section>

          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">How can a user access, change, and/or delete personal information?</h2>
            <p>You may access, correct, update, and/or delete any personally-identifiable information that you submit to the web site. You may also unsubscribe from mailing lists or any registrations on the web site. To do so, please either follow instructions on the page of the web site on which you have provided such information or subscribed or registered or contact us at support@ascendantacademy.ca.</p>
          </section>

          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">Children's privacy</h2>
            <p>ascendantacademy.ca will not intentionally collect any personal information (such as a child's name or email address) from children under the age of 13. If you think that we have collected personal information from a child under the age of 13, please contact us.</p>
          </section>

          <section className="bg-[#111111] p-6 rounded-lg border border-gray-800">
            <h2 className="text-xl font-bold mb-4 text-white">Changes</h2>
            <p>ascendantacademy.ca reserves the right to modify this statement at any time. Any changes to this Privacy Policy will be listed in this section, and if such changes are material, a notice will be included on the homepage of the web site for a period of time. If you have any questions about privacy at any websites operated by ascendantacademy.ca or about our website practices, please contact us at: support@ascendantacademy.ca</p>
          </section>
        </div>
      </div>
    </div>
